      ...
      >
        ...
        <Box
          sx={{
            ...
            gridRow: { xs: "5", sm: "5", md: "5", lg: "1", xl: "1" },
          }}
          display="flex"
        >
          <SimpleStatBox
        ...
        <Box
          sx={{
            ...
            gridRow: { xs: "5", sm: "5", md: "5", lg: "2", xl: "2" },
          }}
          display="flex"
        >
        ...
        <Box
          sx={{
            ...
            gridRow: { xs: "5", sm: "5", md: "5", lg: "3", xl: "3" },
          }}
          display="flex"
        >
          <SimpleStatBox
        ...
        <Box
          sx={{
            ...
            gridRow: { xs: "6", sm: "6", md: "6", lg: "5", xl: "5" },
          }}
          display="flex"
        >
        ...
        <Box
          sx={{
            ...
            gridRow: { xs: "7", sm: "7", md: "7", lg: "5", xl: "5" },
          }}
          display="flex"
        >
          <SimpleStatBox
